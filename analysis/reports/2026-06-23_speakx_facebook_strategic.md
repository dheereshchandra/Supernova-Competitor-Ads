...
|---|--:|--:|--:|
| human_only | 299 | 145 | 0.485 |
| ai_plus_human | 188 | 104 | 0.553 |
| other | 16 | 4 | 0.25 |
| ai_plus_ai | 4 | 2 | 0.5 |
| paper_translation | 4 | 4 | 1.0 |
| split_screen | 168 | 102 | 0.607 |
| TOTAL | 511 | 259 | 0.507 |

*split-screen ads (captured both above and in `speakx_raw_format_counts.csv`): 168.*
...
|---|--:|--:|--:|
| fear-shame | 183 | 83 | 0.454 |
| speak-correctly | 90 | 53 | 0.589 |
| understand-cant-speak | 80 | 46 | 0.575 |
...
*Price / offer hook present in 253 of 511 ads. Split-screen role split in `speakx_by_split_role.csv`.*

## Q5 AI vs human production

| production class | ads | win ratio |
|---|--:|--:|
| AI-heavy (ai_plus_ai + ai_plus_human) | 192 | 0.552 |
| human_only | 299 | 0.485 |
...
| 2026-06-08 | 38 | 0 | 121 | 23 | 0.19 |
| 2026-06-15 | 18 | 0 | 29 | 0 | 0.0 |
| 2026-06-22 | 26 | 0 | 38 | 1 | 0.026 |
...
| exact_replica | 128 | 9.0 | 10.7 | 0 | 27 |
| reworded_replica | 48 | 9.0 | 9.8 | 0 | 22 |
